...
//             </div>
//         <div>
//           <nav className='Navbar-teal Navbar-shadow'>
//               <Button className='Navbar-left Navbar-button' onClick={this.onClick} >
//                 <div className='caption'>
//                       <Icon name='bars' scale={2} />
//                 </div>
//               </Button>
//               <div className='Navbar-container'>
//                 <img src='/logo-white.png'  className={`Navbar-Img align-items-center ${props.hidden ? 'hidden' : ''} ${className}`} alt='Garasi.id' />
//               </div>
//           </nav>
//           </div>
//           </div>
